...
func listAndActionComputeInstantSnapshot(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://compute.googleapis.com/compute/alpha/projects/{{project}}/aggregated/instantSnapshots", "?")[0]
...
func deleteResourceComputeInstantSnapshot(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://compute.googleapis.com/compute/alpha/projects/{{project}}/zones/{{zone}}/instantSnapshots/{{name}}"
	if obj["zone"] == nil {
