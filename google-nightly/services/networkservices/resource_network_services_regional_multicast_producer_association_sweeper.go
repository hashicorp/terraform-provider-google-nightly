...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkServicesRegionalMulticastProducerAssociation,
		DeleteFunction: testSweepNetworkServicesRegionalMulticastProducerAssociation,
	}
...
func testSweepNetworkServicesRegionalMulticastProducerAssociation(_ string) error {
	return listAndActionNetworkServicesRegionalMulticastProducerAssociation(deleteResourceNetworkServicesRegionalMulticastProducerAssociation)
}

func listAndActionNetworkServicesRegionalMulticastProducerAssociation(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkServicesRegionalMulticastProducerAssociation"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networkservices.googleapis.com/v1alpha1/projects/{{project}}/locations/{{location}}/regionalMulticastProducerAssociations", "?")[0]
		...
		resourceList, ok := res["regionalMulticastProducerAssociations"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'regionalMulticastProducerAssociations'")
		} else {
...
func deleteResourceNetworkServicesRegionalMulticastProducerAssociation(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networkservices.googleapis.com/v1alpha1/projects/{{project}}/locations/{{location}}/regionalMulticastProducerAssociations/{{regional_multicast_producer_association_id}}"
