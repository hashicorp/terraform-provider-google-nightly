...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkServicesRegionalMulticastGroupProducerActivation,
		DeleteFunction: testSweepNetworkServicesRegionalMulticastGroupProducerActivation,
	}
...
func testSweepNetworkServicesRegionalMulticastGroupProducerActivation(_ string) error {
	return listAndActionNetworkServicesRegionalMulticastGroupProducerActivation(deleteResourceNetworkServicesRegionalMulticastGroupProducerActivation)
}

func listAndActionNetworkServicesRegionalMulticastGroupProducerActivation(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkServicesRegionalMulticastGroupProducerActivation"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networkservices.googleapis.com/v1alpha1/projects/{{project}}/locations/{{location}}/regionalMulticastGroupProducerActivations", "?")[0]
		...
		resourceList, ok := res["regionalMulticastGroupProducerActivations"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'regionalMulticastGroupProducerActivations'")
		} else {
...
func deleteResourceNetworkServicesRegionalMulticastGroupProducerActivation(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networkservices.googleapis.com/v1alpha1/projects/{{project}}/locations/{{location}}/regionalMulticastGroupProducerActivations/{{regional_multicast_group_producer_activation_id}}"
