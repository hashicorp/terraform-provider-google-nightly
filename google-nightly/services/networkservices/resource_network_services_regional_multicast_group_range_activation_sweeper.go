...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkServicesRegionalMulticastGroupRangeActivation,
		DeleteFunction: testSweepNetworkServicesRegionalMulticastGroupRangeActivation,
	}
...
func testSweepNetworkServicesRegionalMulticastGroupRangeActivation(_ string) error {
	return listAndActionNetworkServicesRegionalMulticastGroupRangeActivation(deleteResourceNetworkServicesRegionalMulticastGroupRangeActivation)
}

func listAndActionNetworkServicesRegionalMulticastGroupRangeActivation(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkServicesRegionalMulticastGroupRangeActivation"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networkservices.googleapis.com/v1alpha1/projects/{{project}}/locations/{{location}}/regionalMulticastGroupRangeActivations", "?")[0]
		...
		resourceList, ok := res["regionalMulticastGroupRangeActivations"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'regionalMulticastGroupRangeActivations'")
		} else {
...
func deleteResourceNetworkServicesRegionalMulticastGroupRangeActivation(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networkservices.googleapis.com/v1alpha1/projects/{{project}}/locations/{{location}}/regionalMulticastGroupRangeActivations/{{regional_multicast_group_range_activation_id}}"
