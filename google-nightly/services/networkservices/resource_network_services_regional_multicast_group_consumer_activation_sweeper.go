...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkServicesRegionalMulticastGroupConsumerActivation,
		DeleteFunction: testSweepNetworkServicesRegionalMulticastGroupConsumerActivation,
	}
...
func testSweepNetworkServicesRegionalMulticastGroupConsumerActivation(_ string) error {
	return listAndActionNetworkServicesRegionalMulticastGroupConsumerActivation(deleteResourceNetworkServicesRegionalMulticastGroupConsumerActivation)
}

func listAndActionNetworkServicesRegionalMulticastGroupConsumerActivation(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkServicesRegionalMulticastGroupConsumerActivation"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networkservices.googleapis.com/v1alpha1/projects/{{project}}/locations/{{location}}/regionalMulticastGroupConsumerActivations", "?")[0]
		...
		resourceList, ok := res["regionalMulticastGroupConsumerActivations"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'regionalMulticastGroupConsumerActivations'")
		} else {
...
func deleteResourceNetworkServicesRegionalMulticastGroupConsumerActivation(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networkservices.googleapis.com/v1alpha1/projects/{{project}}/locations/{{location}}/regionalMulticastGroupConsumerActivations/{{regional_multicast_group_consumer_activation_id}}"
